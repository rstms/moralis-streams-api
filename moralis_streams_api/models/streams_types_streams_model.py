...
class StreamsTypesStreamsModel(object):
    ...
    def webhook_url(self):
        """Gets the webhook_url of this StreamsTypesStreamsModel.  # noqa: E501

        Webhook URL where moralis will send the POST request.  # noqa: E501

        :return: The webhook_url of this StreamsTypesStreamsModel.  # noqa: E501
        :rtype: str
        """
    ...
    def webhook_url(self, webhook_url):
        """Sets the webhook_url of this StreamsTypesStreamsModel.

        Webhook URL where moralis will send the POST request.  # noqa: E501

        :param webhook_url: The webhook_url of this StreamsTypesStreamsModel.  # noqa: E501
        :type: str
        """
    ...
    def description(self):
        """Gets the description of this StreamsTypesStreamsModel.  # noqa: E501

        A description for this stream  # noqa: E501

        :return: The description of this StreamsTypesStreamsModel.  # noqa: E501
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this StreamsTypesStreamsModel.

        A description for this stream  # noqa: E501

        :param description: The description of this StreamsTypesStreamsModel.  # noqa: E501
        :type: str
        """
    ...
    @property
    def tag(self):
        """Gets the tag of this StreamsTypesStreamsModel.  # noqa: E501
        ...
        :return: The tag of this StreamsTypesStreamsModel.  # noqa: E501
        :rtype: str
        """
        return self._tag
    ...
    @tag.setter
    def tag(self, tag):
        """Sets the tag of this StreamsTypesStreamsModel.

        A user-provided tag that will be send along the webhook, the user can use this tag to identify the specific stream if multiple streams are present  # noqa: E501

        :param tag: The tag of this StreamsTypesStreamsModel.  # noqa: E501
        :type: str
        """
        if tag is None:
    ...
    def include_native_txs(self):
        """Gets the include_native_txs of this StreamsTypesStreamsModel.  # noqa: E501

        Include or not native transactions defaults to false (only applied when type:contract)  # noqa: E501

        :return: The include_native_txs of this StreamsTypesStreamsModel.  # noqa: E501
        :rtype: bool
        """
    ...
    def include_native_txs(self, include_native_txs):
        """Sets the include_native_txs of this StreamsTypesStreamsModel.

        Include or not native transactions defaults to false (only applied when type:contract)  # noqa: E501

        :param include_native_txs: The include_native_txs of this StreamsTypesStreamsModel.  # noqa: E501
        :type: bool
        """
    ...
    @abi.setter
    def abi(self, abi):
        """Sets the abi of this StreamsTypesStreamsModel.
    ...
    @property
    def chain_ids(self):
        """Gets the chain_ids of this StreamsTypesStreamsModel.  # noqa: E501

        The ids of the chains for this stream in hex Ex: [\"0x1\",\"0x38\"]  # noqa: E501

        :return: The chain_ids of this StreamsTypesStreamsModel.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def chain_ids(self, chain_ids):
        """Sets the chain_ids of this StreamsTypesStreamsModel.

        The ids of the chains for this stream in hex Ex: [\"0x1\",\"0x38\"]  # noqa: E501

        :param chain_ids: The chain_ids of this StreamsTypesStreamsModel.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def id(self):
        """Gets the id of this StreamsTypesStreamsModel.  # noqa: E501


        :return: The id of this StreamsTypesStreamsModel.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this StreamsTypesStreamsModel.


        :param id: The id of this StreamsTypesStreamsModel.  # noqa: E501
        :type: str
        """
        if id is None:
    ...
    @property
    def status(self):
        """Gets the status of this StreamsTypesStreamsModel.  # noqa: E501


        :return: The status of this StreamsTypesStreamsModel.  # noqa: E501
        :rtype: StreamsStatus
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this StreamsTypesStreamsModel.


        :param status: The status of this StreamsTypesStreamsModel.  # noqa: E501
        :type: StreamsStatus
        """
        if status is None:
    ...
    def status_message(self):
        """Gets the status_message of this StreamsTypesStreamsModel.  # noqa: E501

        Description of current status of stream.  # noqa: E501

        :return: The status_message of this StreamsTypesStreamsModel.  # noqa: E501
        :rtype: str
        """
    ...
    def status_message(self, status_message):
        """Sets the status_message of this StreamsTypesStreamsModel.

        Description of current status of stream.  # noqa: E501

        :param status_message: The status_message of this StreamsTypesStreamsModel.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(StreamsTypesStreamsModel, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, StreamsTypesStreamsModel):
            return False
